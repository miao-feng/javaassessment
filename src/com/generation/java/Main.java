...
public class Main
{
    ...
    private static void showStudentsSummary( StudentService studentService, Scanner scanner )
    {
        if (!studentService.showSummary())
        {
            ...
            String summary = studentService.studentSummary();
    ...
    private static void gradeStudent( StudentService studentService, CourseService courseService, Scanner scanner )
    {
        ...
        //user to select enrolled course to be graded
        String courseId = scanner.next();
        Course course = student.findCourseById(courseId);
        if (course == null) {
            System.out.println("The student is not enrolled to course with ID: " + courseId);
        } else {
